...
<div class="mt-6">
  <table class="w-full text-sm border-collapse">
    ...
    <tbody>
      ...
      <tr class="border-b border-slate-100 hover:bg-slate-50 transition-colors">
        <td class="px-4 py-3 font-semibold text-slate-800">洋的简历</td>
        <td class="px-4 py-3">
          <a href="/resume/yang-god.pdf" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-xs font-bold rounded-lg transition-colors no-underline">
            📄 查看简历
          </a>
        </td>
        <td class="px-4 py-3 text-slate-500 text-xs">2026.7.15</td>
        <td class="px-4 py-3 text-slate-500 text-xs">Java + Golang + Agent</td>
      </tr>
      <tr class="hover:bg-slate-50 transition-colors">
        <td class="px-4 py-3 font-semibold text-slate-800">丁车的简历</td>
        <td class="px-4 py-3">
          <a href="/resume/ding-car.pdf" target="_blank" class="inline-flex items-center gap-1.5 px-3 py-1 bg-blue-500 hover:bg-blue-600 text-white text-xs font-bold rounded-lg transition-colors no-underline">
            📄 查看简历
          </a>
        </td>
        <td class="px-4 py-3 text-slate-500 text-xs">2026.7.15</td>
        <td class="px-4 py-3 text-slate-500 text-xs">老一辈 Java 开发</td>
      </tr>
    </tbody>
  </table>
...
<div class="flex justify-center gap-6 mt-8">
  <div class="px-8 py-4 bg-orange-500 rounded-2xl shadow-lg opacity-60">
...
h1 {
  ...
  background-image: linear-gradient(45deg, #fb923c 10%, #dc2626 60%);
  background-size: 100%;
...
<div class="col-span-2 bg-gradient-to-br from-amber-500 to-orange-700 rounded-2xl p-5 flex flex-col justify-between text-white shadow-xl shadow-orange-700/40">
  <div>
    <div class="text-4xl mb-3">🎮</div>
    <div class="text-2xl font-black tracking-wide">米哈游</div>
    <div class="text-xs opacity-60 mt-1 font-medium uppercase tracking-widest">miHoYo · 技术提前批</div>
  </div>
...
<div class="col-span-3 flex flex-col gap-3">
  <div class="bg-gradient-to-r from-yellow-400 to-orange-500 rounded-xl p-3.5 text-white flex items-center gap-3 shadow-md shadow-orange-400/30">
    <span class="text-2xl">🎯</span>
    <div>
      <div class="font-black text-base">免笔试直通面试</div>
      <div class="text-xs opacity-90">提前批专属特权，尽早投递锁定岗位</div>
    </div>
  </div>
  <div class="grid grid-cols-2 gap-2.5 flex-1">
    <div class="bg-white rounded-xl p-3 border border-amber-100 flex items-center gap-2.5 shadow-sm">
      <span class="text-lg">💻</span><span class="text-xs text-slate-800 font-semibold">程序 & 技术</span>
    </div>
    <div class="bg-white rounded-xl p-3 border border-amber-100 flex items-center gap-2.5 shadow-sm">
      <span class="text-lg">🧪</span><span class="text-xs text-slate-800 font-semibold">质量管理</span>
    </div>
    <div class="bg-white rounded-xl p-3 border border-amber-100 flex items-center gap-2.5 shadow-sm">
      <span class="text-lg">🎨</span><span class="text-xs text-slate-800 font-semibold">技术美术</span>
    </div>
    <div class="bg-white rounded-xl p-3 border border-amber-100 flex items-center gap-2.5 shadow-sm">
      <span class="text-lg">📐</span><span class="text-xs text-slate-800 font-semibold">技术策划</span>
    </div>
  </div>
...
<div class="flex justify-center gap-6 mt-8">
  <div class="px-8 py-4 bg-emerald-600 rounded-2xl shadow-lg opacity-60">
    <div class="text-3xl mb-1">⏳</div>
    <div class="text-sm font-bold text-white">信息整理中</div>
  </div>
</div>
...
h1 {
  ...
  background-image: linear-gradient(45deg, #34d399 10%, #065f46 60%);
  background-size: 100%;
  -webkit-background-clip: text;
  -moz-background-clip: text;
  -webkit-text-fill-color: transparent;
...
<p class="text-orange-300 mt-1 text-lg font-semibold">WLB 才是真</p>

<div class="flex justify-center mt-16">
  <div class="relative" style="width:340px; height:240px;">
    <svg viewBox="0 0 340 240" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:100%;">
      <defs>
      ...
      <polygon points="170,18 18,218 322,218" fill="#f97316" fill-opacity="0.08" stroke="#f97316" stroke-width="2.5" stroke-linejoin="round"/>
      <circle cx="170" cy="18" r="6" fill="#f97316"/>
      <circle cx="18" cy="218" r="6" fill="#f97316"/>
      <circle cx="322" cy="218" r="6" fill="#f97316"/>
      <circle cx="170" cy="138" r="28" fill="none" stroke="#ef4444" stroke-width="2.5" opacity="0.9"/>
      <line x1="150" y1="118" x2="190" y2="158" stroke="#ef4444" stroke-width="2.5" stroke-linecap="round" opacity="0.9"/>
    </svg>
    <div style="position:absolute;top:0;left:50%;transform:translate(-50%,-110%)" class="whitespace-nowrap">
      <span class="px-3 py-1 rounded-full text-sm font-bold bg-orange-500 text-white shadow-lg">🏠 离家近</span>
    </div>
    <div style="position:absolute;bottom:0;left:0;transform:translate(-10%,110%)" class="whitespace-nowrap">
      <span class="px-3 py-1 rounded-full text-sm font-bold bg-orange-500 text-white shadow-lg">😌 强度低</span>
    </div>
    <div style="position:absolute;bottom:0;right:0;transform:translate(10%,110%)" class="whitespace-nowrap">
      <span class="px-3 py-1 rounded-full text-sm font-bold bg-orange-500 text-white shadow-lg">💰 工资高</span>
    </div>
  </div>
</div>
