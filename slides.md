...
在 5G 车联网系统中，车辆 UE 通过移动 5G 基站 gNB 连接到网络，现有的 5G-V2N 安全机制存在结构性缺陷，核心矛盾有以下四个

1. **现有 5G Secondary Authentication 不验证 gNB**：NAS 层只认证 UE ↔ 核心网，MEC 场景下，服务是 gNB 提供，导致 FBS（假基站）攻击风险真实存在
2. **多服务接入 → 多次认证**：车辆往往需要 eMBB + URLLC + 定制边缘服务，重复认证 = 高延迟 + 高通信开销
3. **5G Handover 的“假 KF/BS”**：$K_{gNB}\rightarrow K_{gNB_t}$ 派生，一旦 gNB 或 KgNB 泄露，**历史 / 未来会话全部暴露**，且 gNB 能“偷窥”其他 gNB 与车辆的交互
